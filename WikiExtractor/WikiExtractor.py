...
def process_dump(input_file, template_file, out_file, file_size, file_compress,
    ...
    if input_file == '-':
        ...
        input = fileinput.FileInput(input_file, openhook=fileinput.hook_compressed_encoded)
        ...
        if template_file:
            if os.path.exists(template_file):
                ...
                file = fileinput.FileInput(template_file,
                                           openhook=fileinput.hook_compressed_encoded)
                load_templates(file)
                file.close()
            else:
                if input_file == '-':
...
def main():
    ...
    if args.article:
        ...
        file = fileinput.FileInput(input_file, openhook=fileinput.hook_compressed_encoded)
